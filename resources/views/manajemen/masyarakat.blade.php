@extends('manajemen')
@section('title', 'Masyarakat Umum - E-Kuesioner')
@section('page_title', 'Masyarakat Umum')
@section('content')
<div class="container mt-4 text-center">
    <h4 class="mb-4 fw-bold">Masyarakat Umum</h4>
...
form.addEventListener('submit',e=>{
 e.preventDefault();const judul=document.getElementById('judul').value.trim();if(!judul)return alert('Judul tidak boleh kosong');
